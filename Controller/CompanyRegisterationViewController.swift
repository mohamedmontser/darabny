...
extension CompanyRegisterationViewController
{
    ...
    func initiate( dropDown: DropDown,view:UIView)
    {
        ...
        //dropDown.appearance().textFont = UIFont(name: "Cairo-Regular", size: 17)!
    ...
    func selectCity(atIndex index:Int, withName name:String)
    {
        ...
        self.cityLabel.font = UIFont (name: "Cairo-Regular", size: 17)
    ...
    func selectType(atIndex index:Int, withName name:String)
    {
        ...
        self.typeLabel.font = UIFont (name: "Cairo-Regular", size: 17)
    ...
    func selectSize(atIndex index:Int, withName name:String)
    {
        ...
        self.sizeLabel.font = UIFont (name: "Cairo-Regular", size: 17)
    ...
    func selectIndustry(atIndex index:Int, withName name:String)
    {
        ...
        self.fieldLabel.font = UIFont (name: "Cairo-Regular", size: 17)
...
//        }
        ...
        {
            //displayAlert(localizedSitringFor(key: ""), forController: self)
            return false
        }
