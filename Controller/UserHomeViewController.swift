...
//  Darabny
//
//  Created by Wafaa Farrag on 1/31/18.
...
class UserHomeViewController: UIViewController {
   ...
   let refresher: UIRefreshControl = UIRefreshControl()
    ...
    {
        SearchPopupView.getInstance(forController: self, andView: self.view)
    }
...
// MARK: - Networking
extension UserHomeViewController: NetworkingHelperDeleget
{
