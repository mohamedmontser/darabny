...
extension CompanyHomeViewController:NetworkingHelperDeleget
{
    ...
    func getInternsRequest(withLoader:Bool)
    {
        ...
        network.connectTo(api: ApiNames.COMAPNY_INTERNS, withParameters: ["apiToken":Company.companyShared.apiToken, "page":page,"is_active":1], withLoader: true, forController: self)
    }
